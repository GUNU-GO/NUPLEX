...
class Model:
    ...
    def balance_equations(self,calculation_array, t, power):
        ...
        k3_1 = xs.rate_constant_with_analytic_xs(Te, 'reaction3_1')
        k4_0 = xs.rate_constant_with_analytic_xs(Te, 'reaction4_0')
        k4_1 = xs.rate_constant_with_analytic_xs(Te, 'reaction4_1')
        k4_2 = xs.rate_constant_with_analytic_xs(Te, 'reaction4_2')
        k4_3 = xs.rate_constant_with_analytic_xs(Te, 'reaction4_3')
        k4_4 = xs.rate_constant_with_analytic_xs(Te, 'reaction4_4')
        k4_5 = xs.rate_constant_with_analytic_xs(Te, 'reaction4_5')
        k4_6 = xs.rate_constant_with_analytic_xs(Te, 'reaction4_6')
        k4_7 = xs.rate_constant_with_analytic_xs(Te, 'reaction4_7')
        k4_8 = xs.rate_constant_with_analytic_xs(Te, 'reaction4_8')
        ...
        k6_0 = xs.rate_constant_with_analytic_xs(Te, 'reaction6_0')
        k6_1 = xs.rate_constant_with_analytic_xs(Te, 'reaction6_1')
        k6_2 = xs.rate_constant_with_analytic_xs(Te, 'reaction6_2')
        k6_3 = xs.rate_constant_with_analytic_xs(Te, 'reaction6_2') #xs 데이터 보완 必
        k6_4 = xs.rate_constant_with_analytic_xs(Te, 'reaction6_5') #xs 데이터 보완 必
        k6_5 = xs.rate_constant_with_analytic_xs(Te, 'reaction6_5')
        k6_6 = xs.rate_constant_with_analytic_xs(Te, 'reaction6_6')
        k6_7 = xs.rate_constant_with_analytic_xs(Te, 'reaction6_7')
        k6_8 = xs.rate_constant_with_analytic_xs(Te, 'reaction6_8')
        k6_9 = xs.rate_constant_with_analytic_xs(Te, 'reaction6_9')
    ...
    def routine(self,init_value):
        routine_result = odeint(self.balance_equations, init_value, self.routine_time_interval, args=(self.pulse_power,), rtol=10**-3, mxstep=10**6)
        return routine_result

    def calculation(self):
        #init_value = [3, 1e10, 1e10, 1e10, 1e10, 1e10, 1e10, 1e10, 1e10, 1e10, 1e10, 1e10, 1e10, 1e10, 1e10, 1e10]
        init_value = [3, 1e16, 1e16, 1e16, 1e16, 1e16, 1e16, 1e16, 1e16, 1e16, 1e16, 1e16, 1e16, 1e16, 1e16, 1e16]
        ...
        while True:
            ...
            if not isclose(routine_result[:,15][-1], Hm_compare, rel_tol=1e-2): #iteration stop condition
                if count > 100:
